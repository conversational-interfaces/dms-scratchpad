...
ace.define("ace/mode/dmpl_worker", ['require', 'exports', 'module', 'ace/lib/oop', 'ace/worker/mirror'], function (require, exports, module) {
    "use strict";
    const oop = require('ace/lib/oop');
    const Mirror = require('ace/worker/mirror').Mirror;

    let DMPLWorker = exports.DMPLWorker = function (sender) {
        Mirror.call(this, sender);
        this.setTimeout(1000);
    };

    oop.inherits(DMPLWorker, Mirror);
    ...
    (function () {
        ...
        //         });
        //     }
        //     parent.sender.emit("annotate", errors);
        // };
    }).call(DMPLWorker.prototype);
});
